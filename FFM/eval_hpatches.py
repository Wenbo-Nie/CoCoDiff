...
if __name__ == "__main__":
    ...
    parser.add_argument('--hpatches_path', type=str, default='', help='path to hpatches dataset')
    parser.add_argument('--kpts_path', type=str, default='', help='path to 1k superpoint keypoints')
    parser.add_argument('--save_path', type=str, default='.', help='path to save features')
    parser.add_argument('--dift_model', choices=['sd', 'adm'], default='', help="which dift version to use")
